...
Le dernier partron utilisé est la stratégie. Le créateur carte va faire appel à l'algorythme de création de carte développé en C++. Mais l'appel a cet algorithme sera différence selon le type de carte à utiliser. (On rappelle que l'on considère dans notre implémentation trois types de cartes : Démo, Petite et Normale).
