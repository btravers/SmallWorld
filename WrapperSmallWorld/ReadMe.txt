...
AppWizard a créé cette DLL WrapperSmallWorld pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application WrapperSmallWorld.

WrapperSmallWorld.vcxproj
...
WrapperSmallWorld.vcxproj.filters
